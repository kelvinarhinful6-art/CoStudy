...
import type { TabProps, StudyTask } from "../types";

export default function StudyPlannerScreen({ navigation }: TabProps<"Planner">) {
            ...
            <BlurView key={t.taskId} intensity={24} tint="light" style={styles.taskCard}>
              <TouchableOpacity style={styles.taskLeft} onPress={() => handleToggle(t.taskId)}>
                <Ionicons
                  ...
                  size={24}
                  color={t.isCompleted ? "#1f9d6b" : "#fff"}
                />
              </TouchableOpacity>
              <View style={{ flex: 1 }}>
                ...
                <View style={styles.taskMeta}>
                  ...
                  {t.deadline && (
                    <Text style={styles.deadlineText}>Due: {new Date(t.deadline).toLocaleDateString()}</Text>
                  )}
                </View>
              </View>
