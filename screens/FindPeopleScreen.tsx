            ...
            {viewingPerson && (
              <>
                <View style={styles.modalAvatar}>
                  <Text style={styles.modalAvatarText}>{(viewingPerson.username || "?").charAt(0).toUpperCase()}</Text>
                </View>
                ...
                <View style={styles.modalInfoRow}>
                  ...
                  <Text style={styles.modalInfoText}>{viewingPerson.fullName || "Full name not set"}</Text>
                </View>
                <View style={styles.modalInfoRow}>
                  <Ionicons name="book-outline" size={16} color="rgba(255,255,255,0.85)" />
                  <Text style={styles.modalInfoText}>{viewingPerson.program || "Program not set"}</Text>
                </View>
                <View style={styles.modalInfoRow}>
