...
import { session, myGroups, myInvites } from "../api";
...
const sections = [
  ...
  { key: "Planner", icon: "calendar-outline", sub: "Tasks & deadlines", screen: "StudyPlanner" },
...
const styles = StyleSheet.create({
  ...
  badgeDot: { position: "absolute", top: 12, right: 12, width: 10, height: 10, borderRadius: 5, backgroundColor: "#1f9d6b", borderWidth: 1, borderColor: "#fff" }
});