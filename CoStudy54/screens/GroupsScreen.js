...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: "rgba(255,255,255,0.14)", borderWidth: 1, borderColor: "rgba(255,255,255,0.3)", borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, color: colors.white, fontSize: 14, marginBottom: 10 },
  ...
  empty: { borderRadius: 16, padding: 24, alignItems: "center", gap: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.22)", overflow: "hidden" },
  emptyText: { color: "rgba(255,255,255,0.85)", fontSize: 14, textAlign: "center" },
  groupCard: { flexDirection: "row", alignItems: "center", borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.22)", overflow: "hidden" },
  groupName: { color: colors.white, fontSize: 16, fontWeight: "600" },
  groupCourse: { color: "rgba(255,255,255,0.8)", fontSize: 13, marginTop: 2 },
  memberCount: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: "rgba(255,255,255,0.14)", borderRadius: 10, paddingHorizontal: 8, paddingVertical: 4 },
